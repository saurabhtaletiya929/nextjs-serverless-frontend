...
const SearchResults = ({ search, filters, handleClick, showDropdown }) => {
  ...
  if (loading && !data)
    return <div className={styles.searchresult_container}>⌚️ Loading...</div>;

  if (products.length === 0)
    return (
      <div className={styles.searchresult_container}>🧐 No products found.</div>
    );
